...
public class EventDataSource {
    ...
    public ArrayList<Event> getEvents() {
        ...
        try {
            ...
            while(!cursor.isAfterLast()) {
                ...
                newEvent.setChannelPic(cursor.getBlob(6));
                newEvent.setModerator(cursor.getString(7));
                newEvent.setModeratorPic(cursor.getBlob(8));
    ...
    public Event getSpecificEvent(int eventId) {
        ...
        if(cursor.moveToFirst()){
            ...
            event.setChannelPic(cursor.getBlob(6));
            event.setModerator(cursor.getString(7));
            event.setModeratorPic(cursor.getBlob(8));
