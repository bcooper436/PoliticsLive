...
public class PoliticalPartyDataSource {
    ...
    public ArrayList<PoliticalParty> getPoliticalParties() {
        ...
        try {
            ...
            while(!cursor.isAfterLast()) {
                ...
                newPoliticalParty.setSquarePicture(cursor.getBlob(3));
                newPoliticalParty.setWidePicture(cursor.getBlob(4));
    ...
    public PoliticalParty getSpecificPoliticalParty(int politicalPartyId) {
        ...
        if(cursor.moveToFirst()){
            ...
            politicalParty.setSquarePicture(cursor.getBlob(3));
            politicalParty.setWidePicture(cursor.getBlob(4));
