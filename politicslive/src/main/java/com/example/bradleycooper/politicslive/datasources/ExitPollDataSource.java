...
import com.example.bradleycooper.politicslive.datamininghelpers.DataMiningItemSet;
import com.example.bradleycooper.politicslive.dataobjects.ExitPoll;
import com.example.bradleycooper.politicslive.dbhelpers.ExitPollDBHelper;
    ...
    public String getMostCommonTypeOfVoterByCandidate(String candidate){
        ...
        for(int i =0; i < resultsList.size(); i++){
            ...
            if(currentDataMiningItemSet.getSupport() > currentMaxSupportCount){
                returnString = "The typical " + candidate + " supporter is " + currentDataMiningItemSet.getItemSetName();
            }
        }
