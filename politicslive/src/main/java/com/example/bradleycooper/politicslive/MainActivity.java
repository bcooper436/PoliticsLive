...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        /*if (id == R.id.nav_home) {
            ...
            Intent intent = new Intent(MainActivity.this, AllPresidentialCandidates.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
        }else if (id == R.id.nav_polls) {
            Intent intent = new Intent(MainActivity.this, AllPolls.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            ...
            Intent intent = new Intent(MainActivity.this, AllPoliticalParties.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
